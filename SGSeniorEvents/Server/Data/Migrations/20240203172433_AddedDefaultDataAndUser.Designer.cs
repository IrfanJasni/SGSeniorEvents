...
namespace SGSeniorEvents.Server.Data.Migrations
{
    ...
    [Migration("20240203172433_AddedDefaultDataAndUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGSeniorEvents.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SGSeniorEvents.Shared.Domain.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGSeniorEvents.Shared.Domain.Colour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGSeniorEvents.Shared.Domain.Make", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SGSeniorEvents.Server.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SGSeniorEvents.Shared.Domain.Booking", b =>
                {
                    b.HasOne("SGSeniorEvents.Shared.Domain.Customer", "Customer")
                        .WithMany("Bookings")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SGSeniorEvents.Shared.Domain.Vehicle", "Vehicle")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("SGSeniorEvents.Shared.Domain.Vehicle", b =>
                {
                    b.HasOne("SGSeniorEvents.Shared.Domain.Colour", "Colour")
                        .WithMany()
                        .HasForeignKey("ColourId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SGSeniorEvents.Shared.Domain.Make", "Make")
                        .WithMany()
                        .HasForeignKey("MakeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SGSeniorEvents.Shared.Domain.Model", "Model")
                        .WithMany()
